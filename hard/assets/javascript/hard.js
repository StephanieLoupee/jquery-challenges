...
//This is going to be an on click, change the style text color
// with the complicating factor of needing to know which color you are now,
// so that the "other" color can be assigned.

    //  * 2. The links on the side of the page – "your name," "section 1," "section 2," etc. –
    //  *    hide every odd-numbered link in the menu.

//Need to dig for this one - hide

    //  * 3. Change every instance of the word "bacon" on the page to be "LASER VISION"

//Looks like a global replace command is in order.  Need to research
